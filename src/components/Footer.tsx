import { Atom, FlaskConical, Mail, Phone, MapPin } from "lucide-react";
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-muted-foreground max-w-md mb-6">
              منصة تعليمية تفاعلية لمحاكاة تجارب الفيزياء والكيمياء. نهدف إلى جعل التعلم ممتعاً وسهلاً للجميع.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#physics" className="text-muted-foreground hover:text-primary transition-colors">تجارب الفيزياء</a></li>
              <li><a href="#chemistry" className="text-muted-foreground hover:text-primary transition-colors">تجارب الكيمياء</a></li>
              <li><a href="#experiments" className="text-muted-foreground hover:text-primary transition-colors">جميع التجارب</a></li>
        ...
        <div className="pt-8 border-t border-border flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-muted-foreground text-sm">
            © 2024 مختبر العلوم. جميع الحقوق محفوظة.
          </p>
